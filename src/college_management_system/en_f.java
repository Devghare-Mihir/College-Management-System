...
public class en_f extends javax.swing.JFrame {

    /**
     * Creates new form en_f
     */
    public en_f() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        enter.setBackground(new java.awt.Color(0, 51, 153));
    ...
    private void enterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterActionPerformed
        try
        {
            Class.forName("com.mysql.jdbc.Driver");
            Connection conn= DriverManager.getConnection("jdbc:mysql://localhost:3306/cms1","root", "");
            PreparedStatement pst= conn.prepareStatement("INSERT INTO fees_status VALUES (?, ?, ?, ?, ?)");
            
            pst.setString(1, sid.getText());
            pst.setString(2, paid.getText());
            pst.setString(3, rem.getText());
            pst.setString(4, date.getText());
            pst.setString(5, status.getText());
            
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null, "Fees Status Updated Successfully!");
            conn.close();
        }
        catch(Exception e)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(en_f.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
